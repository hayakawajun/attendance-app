...
( 勤怠締め時刻より前であれば、深夜1:00〜4:00の勤務であっても前日分として勤怠を扱います。勤怠締め時刻をまたぐ入力はできません。未退勤のレコード、休憩中のレコードは定刻になると自動補完され、勤怠登録を強制的に締め切ります。詳しくは後述「作成されるダミーデータについて」の「勤怠データ (前々月分)」を参照してください )  
